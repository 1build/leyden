...
export interface Chalkboard<Cols extends number, Rows extends number> {
    children: ReactNode;
...
export const Chalkboard = <Cols extends number, Rows extends number>({
    children,
    editor,
    value,
    onChange,
}: Chalkboard<Cols, Rows>): ReturnType<FC<Chalkboard<Cols, Rows>>> => {
